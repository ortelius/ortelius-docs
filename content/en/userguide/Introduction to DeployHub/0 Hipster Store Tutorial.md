...
To get started, [sign up for Ortelius](https://www.Ortelius.com/free-team-sign-up/). Once you signed up, you will first deploy the Hipster Store _Application Base Version_ to the Hipster Store _Environment_. 
...
<ul><li>Online Store Company - A sample company configuration. See <a href="/userguide/introduction-to-Ortelius/0-hipster-store-tutorial/">Hipster Store </a> </li>
...
We will leave you with how to setup Ortelius for your installation.  See [First Steps](/userguide/first-steps/), for getting your setup completed. Once you have your setup complete you can start publishing _Components_, packaging _Applications_ and performing deployments. 
