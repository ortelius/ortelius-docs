...
The Ortelius frontend ([ortelius/frontend](https://github.com/ortelius/frontend)) is a Next.js application. [Visual Studio Code](https://code.visualstudio.com/) is the recommended editor for all frontend work.
